...
static struct omap_clk omap54xx_clks[] = {
	...
	CLK(NULL,	"dpll_core_h21x2_ck",		&dpll_core_h21x2_ck),
	CLK(NULL,	"c2c_fclk",			&c2c_fclk),
	CLK(NULL,	"c2c_iclk",			&c2c_iclk),
	CLK(NULL,	"custefuse_sys_gfclk_div",	&custefuse_sys_gfclk_div),
	CLK(NULL,	"dpll_core_h11x2_ck",		&dpll_core_h11x2_ck),
	...
	CLK(NULL,	"dpll_iva_h11x2_ck",		&dpll_iva_h11x2_ck),
	CLK(NULL,	"dpll_iva_h12x2_ck",		&dpll_iva_h12x2_ck),
	...
	CLK(NULL,	"dpll_unipro1_ck",		&dpll_unipro1_ck),
	CLK(NULL,	"dpll_unipro1_clkdcoldo",	&dpll_unipro1_clkdcoldo),
	CLK(NULL,	"dpll_unipro1_m2_ck",		&dpll_unipro1_m2_ck),
	CLK(NULL,	"dpll_unipro2_ck",		&dpll_unipro2_ck),
	CLK(NULL,	"dpll_unipro2_clkdcoldo",	&dpll_unipro2_clkdcoldo),
	CLK(NULL,	"dpll_unipro2_m2_ck",		&dpll_unipro2_m2_ck),
	...
	CLK(NULL,	"dss_syc_gfclk_div",		&dss_syc_gfclk_div),
	...
	CLK(NULL,	"lli_txphy_clk",		&lli_txphy_clk),
	CLK(NULL,	"lli_txphy_ls_clk",		&lli_txphy_ls_clk),
	CLK(NULL,	"mmc1_32khz_clk",		&mmc1_32khz_clk),
	...
	CLK(NULL,	"usb_host_hs_hsic480m_p3_clk",	&usb_host_hs_hsic480m_p3_clk),
	...
	CLK(NULL,	"usb_host_hs_hsic60m_p3_clk",	&usb_host_hs_hsic60m_p3_clk),
	...
	CLK(NULL,	"usb_otg_ss_refclk960m",	&usb_otg_ss_refclk960m),
	...
	CLK("4ae18000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("48032000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("48034000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("48036000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("4803e000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("48086000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("48088000.timer",	"timer_sys_ck",		&sys_clkin),
	CLK("40138000.timer",	"timer_sys_ck",		&dss_syc_gfclk_div),
...
int __init omap5xxx_clk_init(void)
{
	...
	if (soc_is_omap54xx()) {
		...
		omap_clocks_register(omap54xx_clks, ARRAY_SIZE(omap54xx_clks));
	}
